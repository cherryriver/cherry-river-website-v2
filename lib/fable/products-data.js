...
export const alisterLogo = "/assets/brands/alister/Logo%20Alister_White.png";

export const order = ["berries", "framboiselime", "pamplemousse", "litchi-tangerine", "boreal", "bleuets", "fraise", "bourbon", "alister-mackenzie", "rhum-ambre", "rhum-epice", "vodka-averse", "vodka-averse-framboise", "vodka-averse-mangue", "vodka-averse-pomme", "vodka-erable", "tequila-silver", "coaticook-vanille", "gin-sans-berries", "liqueur-whisky", "liqueur-amaretto", "liqueur-cafe", "liqueur-orange", "liqueur-vanille", "rtd-mojito", "rtd-cosmo", "rtd-margarita", "rtd-rhum-cola", "rtd-amaretto", "rtd-daiquiri", "rtd-petitsfruits", "rtd-tiki", "rtd-sangria", "rtd-paloma", "rtd-ginlimon", "rtd-orange", "rtd-limonade", "rtd-opemiska-bleuets", "rtd-gintonic", "rtd-gingericedtea", "rtd-limoicedtea", "rtd-litchipample", "rtd-moscow", "rtd-spritzorange", "rtd-margamangue", "rtd-vlpeche", "rtd-vltgcitron", "rtd-vltgframboise", "na-mojito", "na-melon", "na-margarita", "na-amaretto", "na-cosmo", "na-paloma", "na-petitsfruits", "na-orange", "na-sangria"];

export const catOf = { berries: "gins", framboiselime: "gins", pamplemousse: "gins", "litchi-tangerine": "gins", boreal: "gins", bleuets: "gins", fraise: "gins", bourbon: "whiskys", "alister-mackenzie": "whiskys", "rhum-ambre": "rhums", "rhum-epice": "rhums", "vodka-averse": "vodkas", "vodka-averse-framboise": "vodkas", "vodka-averse-mangue": "vodkas", "vodka-averse-pomme": "vodkas", "vodka-erable": "vodkas", "tequila-silver": "tequilas", "coaticook-vanille": "cremes", "gin-sans-berries": "gin-sans", "liqueur-whisky": "liqueurs", "liqueur-amaretto": "liqueurs", "liqueur-cafe": "liqueurs", "liqueur-orange": "liqueurs", "liqueur-vanille": "liqueurs", "rtd-mojito": "rtd-alcool", "rtd-cosmo": "rtd-alcool", "rtd-margarita": "rtd-alcool", "rtd-rhum-cola": "rtd-alcool", "rtd-amaretto": "rtd-alcool", "rtd-daiquiri": "rtd-alcool", "rtd-petitsfruits": "rtd-alcool", "rtd-tiki": "rtd-alcool", "rtd-sangria": "rtd-alcool", "rtd-paloma": "rtd-alcool", "rtd-ginlimon": "rtd-alcool", "rtd-orange": "rtd-alcool", "rtd-limonade": "rtd-alcool", "rtd-opemiska-bleuets": "rtd-alcool", "rtd-gintonic": "rtd-alcool", "rtd-gingericedtea": "rtd-alcool", "rtd-limoicedtea": "rtd-alcool", "rtd-litchipample": "rtd-alcool", "rtd-moscow": "rtd-alcool", "rtd-spritzorange": "rtd-alcool", "rtd-margamangue": "rtd-alcool", "rtd-vlpeche": "rtd-alcool", "rtd-vltgcitron": "rtd-alcool", "rtd-vltgframboise": "rtd-alcool", "na-mojito": "rtd-sans", "na-melon": "rtd-sans", "na-margarita": "rtd-sans", "na-amaretto": "rtd-sans", "na-cosmo": "rtd-sans", "na-paloma": "rtd-sans", "na-petitsfruits": "rtd-sans", "na-orange": "rtd-sans", "na-sangria": "rtd-sans" };
...
export const products = {
    ...
    "litchi-tangerine": {
      brand: "Cherry River", house: "cr", pill: "Litchi & Tangerine",
      eyebrow: "Gin · Litchi & Tangerine", nameMain: "Gin", nameAccent: "Litchi",
      title: "Gin Litchi & Tangerine", short: "Litchi & tangerine",
      origine: "Magog, Québec", caption: "Distillé à Magog · Édition exotique",
      description: "Un gin exotique où la douceur juteuse du litchi rencontre le zeste vif de la tangerine, porté par un genièvre rond et une pointe de cardamome. Gourmand et solaire.",
      notes: { nez: "Litchi mûr et tangerine, pointe épicée de cardamome.", bouche: "Juteuse et ronde, le litchi enveloppe le genièvre.", finale: "Vive et zestée, l'agrume en dernière note." },
      botIntro: "Le litchi et la tangerine rejoignent le genièvre et une touche de cardamome pour un gin exotique et gourmand.",
      bots: ["Genièvre", "Litchi", "Tangerine", "Cardamome", "Zeste d'agrume", "Coriandre", "Angélique"],
      serve: { meta: "Servi long · 5 min", name: "Le Litchi", nameAccent: "Tonic", ing: [{ name: "Gin Litchi & Tangerine", q: "45 ml" }, { name: "Tonic", q: "120 ml" }, { name: "Litchis frais", q: "au goût" }, { name: "Glace", q: "au goût" }], steps: ["Remplir un grand verre de glace.", "Verser le gin, allonger de tonic.", "Garnir de litchis et d'un zeste de tangerine."] }
    },
    "alister-mackenzie": {
      brand: "Alister MacKenzie", house: "alister", pill: "Blended Scotch Whisky", abv: "40 % vol.",
      chips: ["40 % alc./vol", "750 ml", "Distillé en Écosse", "Assemblage classique"],
      eyebrow: "The House of Alister MacKenzie · Blended Scotch Whisky", nameMain: "Blended", nameAccent: "Scotch",
      title: "The House of Alister MacKenzie — Blended Scotch Whisky", short: "Blended Scotch Whisky",
      origine: "Écosse", caption: "Distillé en Écosse · Assemblage classique",
      description: "Un blended Scotch whisky d'assemblage classique, distillé en Écosse pour la maison Alister MacKenzie. Rond et boisé, une minutie tout en retenue.",
      notes: { nez: "Malt d'orge et miel, chêne discret.", bouche: "Ronde et équilibrée, épices douces sur fond boisé.", finale: "Longue et chaleureuse, légère pointe fumée." },
      botIntro: "Un assemblage de malts et de whiskies de grain écossais, vieillis en fût de chêne.",
      bots: ["Orge maltée", "Whisky de grain", "Fût de chêne", "Miel", "Épices douces", "Tourbe légère"],
      serve: { meta: "Sur glace · 2 min", name: "Le Rob", nameAccent: "Roy", ing: [{ name: "Blended Scotch Whisky", q: "60 ml" }, { name: "Vermouth rouge", q: "30 ml" }, { name: "Amers aromatiques", q: "2 traits" }, { name: "Cerise", q: "garniture" }], steps: ["Remuer les ingrédients avec de la glace.", "Filtrer dans une coupe.", "Garnir d'une cerise au marasquin."] }
    },
    "vodka-averse-framboise": {
      brand: "Averse", house: "averse", pill: "Framboise",
      eyebrow: "Vodka · Framboise", nameMain: "Vodka", nameAccent: "Framboise",
      title: "Averse Vodka Framboise", short: "Vodka aromatisée à la framboise",
      origine: "Québec", caption: "Signé Averse · Vodka aromatisée",
      description: "La pureté de la vodka Averse Premium rehaussée de framboise gourmande — vive, fruitée et nette, une signature nordique tout en caractère.",
      notes: { nez: "Framboise fraîche et vive.", bouche: "Ronde et fruitée, la framboise sur une base pure.", finale: "Nette et fruitée, légèrement sucrée." },
      botIntro: "La vodka Averse Premium infusée de framboise pour une signature fruitée et nette.",
      bots: ["Vodka Averse Premium", "Framboise"],
      serve: { meta: "Frappé · 3 min", name: "Le Cosmo", nameAccent: "Framboise", ing: [{ name: "Vodka Framboise", q: "45 ml" }, { name: "Jus de canneberge", q: "20 ml" }, { name: "Jus de lime", q: "10 ml" }, { name: "Glace", q: "au goût" }], steps: ["Frapper avec de la glace.", "Filtrer dans une coupe.", "Garnir d'un zeste de lime."] }
    },
    "vodka-averse-mangue": {
      brand: "Averse", house: "averse", pill: "Mangue",
      eyebrow: "Vodka · Mangue", nameMain: "Vodka", nameAccent: "Mangue",
      title: "Averse Vodka Mangue", short: "Vodka aromatisée à la mangue",
      origine: "Québec", caption: "Signé Averse · Vodka aromatisée",
      description: "La pureté de la vodka Averse Premium rehaussée de mangue solaire — ronde, juteuse et exotique, une signature nordique aux accents tropicaux.",
      notes: { nez: "Mangue mûre et exotique.", bouche: "Ronde et juteuse, la mangue sur une base pure.", finale: "Douce et fruitée, chaleur tropicale." },
      botIntro: "La vodka Averse Premium infusée de mangue pour une signature solaire et ronde.",
      bots: ["Vodka Averse Premium", "Mangue"],
      serve: { meta: "Servi long · 3 min", name: "Le Mangue", nameAccent: "Spritz", ing: [{ name: "Vodka Mangue", q: "45 ml" }, { name: "Eau pétillante", q: "120 ml" }, { name: "Jus de lime", q: "15 ml" }, { name: "Glace", q: "au goût" }], steps: ["Remplir un verre de glace.", "Verser la vodka et la lime.", "Allonger d'eau pétillante."] }
    },
    "vodka-averse-pomme": {
      brand: "Averse", house: "averse", pill: "Pomme",
      eyebrow: "Vodka · Pomme", nameMain: "Vodka", nameAccent: "Pomme",
      title: "Averse Vodka Pomme", short: "Vodka aromatisée à la pomme",
      origine: "Québec", caption: "Signé Averse · Vodka aromatisée",
      description: "La pureté de la vodka Averse Premium rehaussée de pomme verte croquante — fraîche, nette et légèrement acidulée, une signature nordique tout en fraîcheur.",
      notes: { nez: "Pomme verte croquante.", bouche: "Vive et fraîche, la pomme sur une base pure.", finale: "Nette et acidulée, rafraîchissante." },
      botIntro: "La vodka Averse Premium infusée de pomme verte pour une signature fraîche et nette.",
      bots: ["Vodka Averse Premium", "Pomme verte"],
      serve: { meta: "Frappé · 3 min", name: "Le Pomme", nameAccent: "Sour", ing: [{ name: "Vodka Pomme", q: "45 ml" }, { name: "Jus de citron", q: "20 ml" }, { name: "Sirop simple", q: "10 ml" }, { name: "Glace", q: "au goût" }], steps: ["Frapper avec de la glace.", "Filtrer sur glace neuve.", "Garnir d'une tranche de pomme."] }
    },
    "rtd-gintonic": { brand: "Cherry River", house: "cr", pill: "Gin Tonique", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de gin", "Prêt à boire"], eyebrow: "Prêt-à-boire · Gin Tonique", nameMain: "Gin", nameAccent: "Tonique", title: "Cocktail Gin Tonique", short: "Gin & tonic", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "Le classique gin tonique en canette : notre gin signature et tonic de qualité, net et désaltérant. Prêt à savourer bien froid.", notes: { nez: "Genièvre net et agrumes, amertume de quinine.", bouche: "Pétillante et sèche, gin franc sur tonic.", finale: "Nette et rafraîchissante." }, botIntro: "Un cocktail à base de gin et de tonic.", bots: ["Gin", "Tonic", "Zeste d'agrume"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Gin Tonique", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Zeste de citron", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir d'un zeste de citron.", "Servir aussitôt."] } },
    "rtd-gingericedtea": { brand: "Cherry River", house: "cr", pill: "Thé Glacé au Gingembre", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de vodka", "Prêt à boire"], eyebrow: "Prêt-à-boire · Thé Glacé au Gingembre", nameMain: "Thé Glacé", nameAccent: "Gingembre", title: "Cocktail Thé Glacé au Gingembre", short: "Vodka, thé & gingembre", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "Un thé glacé au gingembre en canette : vodka et gingembre piquant sur fond de thé, épicé et rafraîchissant. Prêt à savourer bien froid.", notes: { nez: "Gingembre piquant et thé, note épicée.", bouche: "Vive et épicée, thé rond en soutien.", finale: "Chaleureuse et nette." }, botIntro: "Un cocktail à base de vodka, de thé et de gingembre.", bots: ["Vodka", "Thé", "Gingembre"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Thé Glacé au Gingembre", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Gingembre confit", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir de gingembre confit.", "Servir aussitôt."] } },
    "rtd-limoicedtea": { brand: "Cherry River", house: "cr", pill: "Vodka Limonade Thé Glacé", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de vodka", "Limonade non pétillante"], eyebrow: "Prêt-à-boire · Vodka Limonade Thé Glacé", nameMain: "Limonade", nameAccent: "Thé Glacé", title: "Cocktail Vodka Limonade Thé Glacé", short: "Vodka, limonade & thé glacé", origine: "Magog, Québec", caption: "Limonade non pétillante · 355 ml", description: "Une limonade non pétillante au thé glacé et à la vodka : franche, désaltérante, sans bulles. Prête à savourer bien froide.", notes: { nez: "Citron et thé, note nette.", bouche: "Ronde et non pétillante, thé glacé en soutien.", finale: "Fraîche et désaltérante." }, botIntro: "Une limonade non pétillante à base de vodka, de citron et de thé glacé.", bots: ["Vodka", "Citron", "Thé glacé", "Sucre de canne"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Vodka Limonade Thé Glacé", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Citron", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir d'une tranche de citron.", "Servir aussitôt."] } },
    "rtd-litchipample": { brand: "Cherry River", house: "cr", pill: "Litchi & Pamplemousse", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de gin", "Prêt à boire"], eyebrow: "Prêt-à-boire · Litchi & Pamplemousse", nameMain: "Litchi", nameAccent: "& Pamplemousse", title: "Cocktail Litchi & Pamplemousse", short: "Gin, litchi & pamplemousse", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "Un cocktail de canette gin, litchi et pamplemousse rose : exotique et pétillant, entre douceur fruitée et amertume d'agrume. Prêt à savourer bien froid.", notes: { nez: "Litchi et pamplemousse rose, genièvre léger.", bouche: "Fruitée et pétillante, agrume en soutien.", finale: "Fraîche et légèrement amère." }, botIntro: "Un cocktail à base de gin, de litchi et de pamplemousse rose.", bots: ["Gin", "Litchi", "Pamplemousse rose", "Eau pétillante"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Litchi & Pamplemousse", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Pamplemousse", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir d'une tranche de pamplemousse.", "Servir aussitôt."] } },
    "rtd-moscow": { brand: "Cherry River", house: "cr", pill: "Moscow Mule", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de vodka", "Prêt à boire"], eyebrow: "Prêt-à-boire · Moscow Mule", nameMain: "Moscow", nameAccent: "Mule", title: "Cocktail Moscow Mule", short: "Vodka, gingembre & lime", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "Le Moscow Mule en canette : vodka, gingembre piquant et lime, pétillant et mordant. Prêt à savourer bien froid.", notes: { nez: "Gingembre piquant et lime.", bouche: "Vive et pétillante, gingembre mordant.", finale: "Nette et épicée." }, botIntro: "Un cocktail à base de vodka, de gingembre et de lime.", bots: ["Vodka", "Gingembre", "Lime", "Eau pétillante"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Moscow Mule", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Lime & menthe", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir de lime et de menthe.", "Servir aussitôt."] } },
    "rtd-spritzorange": { brand: "Cherry River", house: "cr", pill: "Orange Spritz", abv: "7 % vol.", chips: ["7 % alc./vol", "355 ml", "À base de vodka", "Prêt à boire"], eyebrow: "Prêt-à-boire · Orange Spritz", nameMain: "Orange", nameAccent: "Spritz", title: "Cocktail Orange Spritz", short: "Vodka & orange pétillante", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "Un spritz à l'orange en canette : vodka et orange pétillante, franc et ensoleillé. Prêt à savourer bien froid.", notes: { nez: "Orange franche et pétillante.", bouche: "Vive et juteuse, orange sur trame nette.", finale: "Fraîche et sèche." }, botIntro: "Un cocktail à base de vodka et d'orange.", bots: ["Vodka", "Orange", "Eau pétillante"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Orange Spritz", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Tranche d'orange", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir d'une tranche d'orange.", "Servir aussitôt."] } },
    "rtd-margamangue": { brand: "Cherry River", house: "cr", pill: "Margarita à la Mangue", abv: "5 % vol.", chips: ["5 % alc./vol", "355 ml", "À base de tequila", "Prêt à boire"], eyebrow: "Prêt-à-boire · Margarita à la Mangue", nameMain: "Margarita", nameAccent: "Mangue", title: "Cocktail Margarita à la Mangue", short: "Tequila, mangue & lime", origine: "Magog, Québec", caption: "Cocktail prêt-à-boire · 355 ml", description: "La margarita à la mangue en canette : tequila et mangue solaire, fruitée et ensoleillée. Prête à verser sur glace, bord de sel en option.", notes: { nez: "Mangue mûre et agave.", bouche: "Ronde et fruitée, tequila et mangue.", finale: "Douce et légèrement acidulée." }, botIntro: "Un cocktail à base de tequila, de mangue et de lime.", bots: ["Tequila", "Mangue", "Lime", "Agave"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Margarita à la Mangue", q: "1 canette" }, { name: "Sel", q: "bord de verre" }, { name: "Mangue", q: "garniture" }], steps: ["Givrer le bord du verre de sel.", "Verser sur glace.", "Garnir d'un morceau de mangue."] } },
    "rtd-vlpeche": { brand: "Cherry River", house: "cr", pill: "Pêche Blanche & Basilic", abv: "5 % vol.", chips: ["5 % alc./vol", "355 ml", "À base de vodka", "Limonade non pétillante"], eyebrow: "Prêt-à-boire · Vodka Limonade Pêche Blanche & Basilic", nameMain: "Pêche", nameAccent: "& Basilic", title: "Cocktail Vodka Limonade Pêche Blanche & Basilic", short: "Vodka, pêche blanche & basilic", origine: "Magog, Québec", caption: "Limonade non pétillante · 355 ml", description: "Une limonade non pétillante à la vodka, pêche blanche et basilic frais : douce, fruitée et herbacée. Prête à savourer bien froide.", notes: { nez: "Pêche blanche mûre et basilic frais.", bouche: "Ronde et juteuse, basilic en soutien.", finale: "Douce et fraîche." }, botIntro: "Une limonade non pétillante à base de vodka, de pêche blanche et de basilic.", bots: ["Vodka", "Pêche blanche", "Basilic", "Citron"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Pêche Blanche & Basilic", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Basilic frais", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir de basilic frais.", "Servir aussitôt."] } },
    "rtd-vltgcitron": { brand: "Cherry River", house: "cr", pill: "Thé Glacé Citron-Lime", abv: "5 % vol.", chips: ["5 % alc./vol", "355 ml", "À base de vodka", "Limonade non pétillante"], eyebrow: "Prêt-à-boire · Vodka Limonade Thé Glacé Citron-Lime", nameMain: "Thé Glacé", nameAccent: "Citron-Lime", title: "Cocktail Vodka Limonade Thé Glacé Citron-Lime", short: "Vodka, thé glacé, citron & lime", origine: "Magog, Québec", caption: "Limonade non pétillante · 355 ml", description: "Une limonade non pétillante au thé glacé, citron et lime : vive, désaltérante et sans bulles. Prête à savourer bien froide.", notes: { nez: "Citron et lime, thé en fond.", bouche: "Vive et acidulée, thé glacé en soutien.", finale: "Nette et rafraîchissante." }, botIntro: "Une limonade non pétillante à base de vodka, de thé glacé, de citron et de lime.", bots: ["Vodka", "Thé glacé", "Citron", "Lime"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Thé Glacé Citron-Lime", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Citron & lime", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir de citron et de lime.", "Servir aussitôt."] } },
    "rtd-vltgframboise": { brand: "Cherry River", house: "cr", pill: "Thé Glacé Framboises", abv: "5 % vol.", chips: ["5 % alc./vol", "355 ml", "À base de vodka", "Limonade non pétillante"], eyebrow: "Prêt-à-boire · Vodka Limonade Thé Glacé Framboises", nameMain: "Thé Glacé", nameAccent: "Framboises", title: "Cocktail Vodka Limonade Thé Glacé Framboises", short: "Vodka, thé glacé & framboises", origine: "Magog, Québec", caption: "Limonade non pétillante · 355 ml", description: "Une limonade non pétillante au thé glacé et aux framboises : fruitée, gourmande et sans bulles. Prête à savourer bien froide.", notes: { nez: "Framboise mûre, thé en fond.", bouche: "Fruitée et ronde, thé glacé en soutien.", finale: "Douce et fruitée." }, botIntro: "Une limonade non pétillante à base de vodka, de thé glacé et de framboises.", bots: ["Vodka", "Thé glacé", "Framboise"], serve: { meta: "Bien froid · 1 min", name: "Sur", nameAccent: "glace", ing: [{ name: "Thé Glacé Framboises", q: "1 canette" }, { name: "Glace", q: "au goût" }, { name: "Framboises", q: "garniture" }], steps: ["Verser sur un verre de glace.", "Garnir de framboises fraîches.", "Servir aussitôt."] } }
  };
