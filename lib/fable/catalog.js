      ...
      subcategories: [
        {
          ...
          items: [
            ...
            { slug: 'limegingembre', label: 'Lime & Gingembre',        house: 'Cherry River' },
        ...
        { key: 'whiskys', label: 'Bourbon whiskey', status: 'live', blurb: 'Master Blend, vieilli en fût de chêne', items: [
